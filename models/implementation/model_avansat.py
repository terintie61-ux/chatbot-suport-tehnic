...
def antreneaza_model_svm():
    ...
    model_path = os.path.join(SAVE_MODEL_DIR, f'model_svm_{timestamp}.pkl')  
    ...
    with open( os.path.join(SAVE_MODEL_DIR, 'model_info_svm.json'), 'w', encoding='utf-8') as f:
...
def compara_modele():
    ...
    try:
        with open( os.path.join(SAVE_MODEL_DIR, 'model_info.json') , 'r') as f:
    ...
    try:
        with open( os.path.join(SAVE_MODEL_DIR, 'model_info_svm.json') , 'r') as f:
