...
def genereaza_statistici():
    ...
    with open( os.path.join(PROCESSED_DATA_PATH, 'statistici.json') , 'w', encoding='utf-8') as f:
...
def main():
    ...
    preproceseaza_intrebari_json(
        os.path.join(RAW_DATA_PATH, 'intrebari_culinare.json'),
        os.path.join(PROCESSED_DATA_PATH, 'intrebari_curatate.json')
    )
    ...
    print("=" * 60)
    print("\n📁 Fișiere create:")
    print("   - data/processed_data/intrebari_curatate.json")
    print("   - data/processed_data/date_antrenare_curatate.csv")
    print("   - data/processed_data/statistici.json")
